...
export const INITIAL_USERS = [
  ...
  },
  {
    ...
    email: 'anil.verma@sahebpaper.com',
  ...
  },
  {
    ...
    roleId: 'pulp_mill',
    roleName: 'Pulper (Pulp Mill Operator)',
  ...
  },
  {
    ...
    workerId: 'EMP-004',
    name: 'Vikram Singh',
    username: 'vikram_dispatch',
    password: 'dispatch@pass2026',
    roleId: 'dispatch',
    roleName: 'Dispatcher',
    email: 'vikram.dispatch@sahebpaper.com',
  ...
  },
  {
    ...
    workerId: 'EMP-005',
    name: 'Amit Patel',
    username: 'amit_shopper',
    password: 'store@pass2026',
    roleId: 'store_keeper',
    roleName: 'Shopper (Store & Procurement)',
    email: 'amit.store@sahebpaper.com',
    phone: '+91 98250 56789',
    status: 'active',
    allowedModules: ['dashboard', 'raw-material', 'store']
  },
  {
    id: 'usr-6',
    workerId: 'GUEST-001',
    name: 'Guest Viewer',
    username: 'guest',
    password: 'guest@pass2026',
    roleId: 'guest_viewer',
    roleName: 'Guest / Read-Only Viewer',
    email: 'guest@sahebpaper.com',
...
export const INITIAL_AUDIT_LOGS = [
  ...
  },
  {
    ...
    workerId: 'EMP-003',
    roleName: 'Plant Manager',
    action: 'Worker Suresh Patel (EMP-003) logged in to Pulper session',
