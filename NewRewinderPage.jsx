...
/**
 * Master Data & Paper Products Configuration
 */
const PRODUCTS = [
...
/**
 * Reusable Components: StatCard & Modal
 */
...
/**
 * Brand New Self-Contained Rewinder Page Component
 */
export default function NewRewinderPage() {
    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B0E1B] p-4 sm:p-6 font-sans text-slate-800 dark:text-white space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        ...
        <StatCard
          ...
          subtitle="Auto Loop-Back to Raw Stock"
          icon={RefreshCw}
        ...
        <StatCard
          ...
          subtitle="Net Yield Output Weight"
          icon={PackageCheck}
          trend="+Ready"
          trendType="up"
        />
      ...
      <div className="bg-white dark:bg-[#12162B] rounded-2xl p-4 sm:p-6 border border-[#EEF0F5] dark:border-[#222943] shadow-[0_8px_24px_rgba(0,0,0,0.04)] space-y-5">
        {/* Table Title & Summary Stats Bar */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div>
            <h2 className="text-lg font-black text-slate-800 dark:text-white">Rewinder Reel Production Log</h2>
            <p className="text-xs text-slate-500 dark:text-slate-400">Date: {formatDateDisplay(selectedDate)} • Broke automatically increases Raw Material Stock</p>
          </div>
        </div>
          ...
          <div className={`p-3.5 rounded-2xl border space-y-3 transition-all ${
            ...
            <div className="space-y-2.5 max-h-[300px] overflow-y-auto pr-1 custom-scrollbar">
              {reelItems.map((item, idx) => (
                <div key={idx} className="p-3 rounded-xl bg-[#F8FAFC] dark:bg-[#12162B] border border-slate-200 dark:border-[#222943] grid grid-cols-1 sm:grid-cols-5 gap-2 items-center shadow-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-full p-2 bg-white dark:bg-[#181D35] border border-slate-200 dark:border-[#262D4A] text-slate-800 dark:text-white rounded-lg text-xs font-bold focus:outline-none focus:ring-1 focus:ring-[#cf8730]"
                    />
                  </div>
                  ...
                  <div>
                    <input
                      ...
                      className="w-full p-2 bg-white dark:bg-[#181D35] border border-slate-200 dark:border-[#262D4A] text-slate-800 dark:text-white rounded-lg text-xs font-extrabold focus:outline-none"
                    />
                  </div>
            ...
            <button
              ...
              className={`px-5 py-3 rounded-xl font-extrabold text-xs transition-all min-h-[44px] cursor-pointer flex items-center justify-center gap-2 ${
                isWeightMismatch || hasDuplicateReelNo
                  ...
                  : 'bg-[#cf8730] hover:bg-[#b57324] text-white shadow-md active:scale-95'
              }`}
            >
              {isWeightMismatch ? (
                <>
